...
demo = gr.TabbedInterface([ list_indexes_tab, create_indexes_tab, converse_with_pdf_tab, delete_index_tab], [ "List Collections", "Create New Collection", "Converse with Collection", "Delete the Collection"])

# Launch the interface
demo.launch(auth=Utilities.get_creds(), auth_message="Provide Username and password", max_file_size="20mb")